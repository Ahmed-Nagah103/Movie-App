...
class TopRatedComponent extends StatefulWidget {
  TopRatedComponent({super.key,this.seeMoreOnTap,required this.categoryTitle});
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          ...
                          return MovieDetailsScreen(moviesCubit.topRatedMovies[index].id);
                        }));
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(16),
                        child: Image.network('${moviesCubit.topRatedMovies[index].backdropPath}',
